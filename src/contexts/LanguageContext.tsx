...
export const translations = {
  ...
  el: {
    ...
    boatMaintenance: "Συντήρηση Σκάφους",
    cleaning: "Καθαρισμός",
    dockingFees: "Τέλη Ελλιμενισμού",
    licensing: "Αδειοδότηση",
    carWash: "Πλύσιμο Αυτοκινήτου",
    employeeSalaries: "Μισθοί Υπαλλήλων",
    vehicleParts: "Ανταλλακτικά Οχήματος",
    other: "Άλλο",
    ...
    selectTimeframe: "Επιλέξτε χρονικό διάστημα",
    filter: "Φίλτρο",
