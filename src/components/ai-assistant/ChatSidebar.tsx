        ...
        <div className="space-y-1">
          {conversations.map(conv => (
            <div
              key={conv.id}
              className={cn(
                "group relative flex items-start gap-2 px-3 py-2.5",
              ...
              <div className="flex-1 min-w-0">
                {editingId === conv.id ? (
                  <input
                    ...
                    className="w-full text-sm font-medium bg-white border border-blue-200 rounded px-1 py-0.5 focus:outline-none focus:ring-1 focus:ring-blue-400"
                    autoFocus
                  />
                ) : (
                ...
                <div className="flex items-center justify-between mt-0.5">
                  ...
                  {/* Action buttons aligned with date */}
                  {editingId === conv.id ? (
